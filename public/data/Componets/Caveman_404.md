...
title: "Pure CSS Caveman 404 Error Page Animation"
description: "A fun and animated 404 error page built using pure HTML and CSS featuring two cavemen characters swinging clubs in sync. No JavaScript required for the animation."
image: "/images/Caveman_404.png"
tags: [HTML, CSS, Animation, 404 Page, Pure CSS, Fun UI]
author: "CodewithLord"
date: 2026-02-08
----------------
...
* `index.html` → Markup for cavemen characters
* `style.css` → All shapes, colors, and animations
...
<html lang="en">
  ...
  <head>
    <meta charset="UTF-8">
    <title>code for fun (day02): 404 error page, Caveman mode - pure CSS</title>
    <link href="https://fonts.googleapis.com/css?family=Concert+One" rel="stylesheet"><link rel="stylesheet" href="./style.css">
...
* Two identical `.caveman` blocks
* Each caveman built from divs (head, arm, legs, club)
...
* Continuous 360° rotation using `@keyframes arm-anima`
* Offset delays for alternating motion
