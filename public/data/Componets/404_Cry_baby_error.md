...
The animation is entirely built using HTML and CSS, without any JavaScript.
Keyframe animations control facial expressions, mouth movement, floating motion, and animated tear drops to create a playful yet emotional “page not found” experience.
...
<html lang="en">
  ...
  <head>
    <meta charset="UTF-8">
    <title>Css only  404 Crying Baby </title>
